    ...
    "@graph": [
      {
        ...
        "@id": `${pageUrl}#webpage`,
        url: pageUrl,
        name: t.locale === "sv" ? "AI-konsult, Customer Success & automation i Sverige" : "AI consulting, Customer Success & automation",
        description: t.hero.description,
        inLanguage: t.locale === "sv" ? "sv-SE" : "en",
        isPartOf: { "@id": "https://www.successifier.se/#website" },
        about: { "@id": "https://www.successifier.se/#organization" },
        primaryImageOfPage: "https://www.successifier.se/opengraph-image",
      },
      {
        "@type": "FAQPage",
        "@id": `${pageUrl}#faq`,
