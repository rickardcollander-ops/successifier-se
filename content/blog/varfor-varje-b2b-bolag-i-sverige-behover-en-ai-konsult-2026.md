...
De flesta B2B-bolag har ett CRM fullt av leads i olika mognadsstadier. AI kan tränas på historisk vunnen och förlorad data för att poängsätta nya leads automatiskt. [HubSpot och Salesforce har inbyggda AI-funktioner](https://www.salesforce.com/se/products/einstein/overview/) för detta, men de fungerar bäst när en konsult konfigurerar dem korrekt mot din specifika säljprocess.
...
En bra konsult är verktygsagnostisk och väljer teknik baserat på ditt behov, inte på vad de råkar känna bäst. Var skeptisk mot konsulter som alltid rekommenderar samma plattform oberoende av kontexten. Fråga: "Under vilka omständigheter skulle ni välja en [öppen modell som Llama 3](https://ai.meta.com/llama/) istället för OpenAI?" Svaret avslöjar mycket om deras faktiska kompetens.
...
Argumentet att "tekniken förändras för snabbt" stämde bättre 2022 än idag. Kärnverktygen (OpenAI, [Anthropic](https://www.anthropic.com/), öppna modeller, [orkestreringslager som LangChain](https://www.langchain.com/)) är tillräckligt mogna för produktionsanvändning. Att vänta på nästa generation modell är som att vänta på att köpa dator tills processorkraften slutat öka: det händer aldrig.
