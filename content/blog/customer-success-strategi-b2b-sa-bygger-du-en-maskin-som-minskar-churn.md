...
En stor nordamerikansk studie från [Gainsight visade](https://www.gainsight.com/blog/the-economics-of-customer-success/) att sannolikheten att rädda ett churning-konto faller dramatiskt efter att kunden aktivt uttryckt missnöje. Vid det laget är förhandlingspositionen svag och rabatter är dyra.
...
Problemet är att manuellt arbete inte skalas. När portfolion växer från 50 kunder till 200 kunder, kan du inte fyra-dubbla teamet. Det är [inte ekonomiskt hållbart](https://hbr.org/2014/10/the-value-of-keeping-the-right-customers), och det är inte nödvändigt.
...
Den mest konkreta onboarding-metriken är [time-to-value (TTV)](https://www.productboard.com/glossary/time-to-value/): hur lång tid tar det från signering till kundens första påvisbara affärsresultat?
...
De flesta health score-modeller är för enkla. De bygger på [NPS](https://www.bain.com/consulting-services/customer-strategy-and-marketing/customer-loyalty/net-promoter-score-system/) (som fångar stämningen vid ett tillfälle), inloggningsfrekvens (som säger lite om värde) och antal öppna support-ärenden (som är ett symptom, inte en orsak).
...
ROI-kalkylen är inte komplex. Om din [genomsnittliga ACV](https://www.openviewpartners.com/blog/what-is-annual-contract-value/) är $20 000 och du minskar churn med 40% i ett segment av 50 kunder med ett initialt churn-rate på 20%, räddar du 4 kunder per år. Det är $80 000 i ARR som annars hade försvunnit, från en investering som kan kosta ett par hundra dollar i månaden.
